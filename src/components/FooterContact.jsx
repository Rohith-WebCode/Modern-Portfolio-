...
const FooterContact = () => {
  return (
    ...
    <div className="absolute inset-0 bg-gradient-to-b from-black/100 via-black/10 to-transparent"></div>
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 ">
     ...
     <button className="relative h-12  overflow-hidden p-[1px] rounded-full text-lg my-5">
          ...
          <div className=''>
          <h4  className='text-white tracking-wid text-base font-semibold lg:text-2xl'>Open to full-time opportunities and freelance collaborations.</h4>
          <h4 className='text-[#afb0b6] class="my-2 text-sm font-extralight tracking-wide text-balance lg:text-xl'>Passionate about building dynamic web applications and creating intuitive user experiences.</h4>
          </div>
    </div>
