...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "group/bento row-span-1 flex flex-col justify-between  space-y-4  relative overflow-hidden rounded-3xl border   p-4 transition duration-200 hover:shadow-xl border-white/[0.2] bg-black shadow-none",
        className
      )}>
